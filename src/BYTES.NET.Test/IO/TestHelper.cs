...
namespace BYTES.NET.Test.IO
{
    ...
    public class TestHelper
    {
        ...
        public void TestPathMethods()
        {
            ...
            Debug.WriteLine("The BYTES.NET library assembly is located at '" + Helper.GetLibraryAssemblyPath() + "'");

            //check for the 'bytes.net.dll' assembly directory path
            Debug.WriteLine("The BYTES.NET library assembly is located in folder '" + Helper.GetLibraryDirPath() + "'");
